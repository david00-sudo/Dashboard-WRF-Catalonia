# WRF-Catalunya Meteorological Dashboard
...
| Radiació (Ona Llarga i Curta) | RRTMG scheme | d01, d02, d03 |
| Física de Superfície | Unified Noah land-surface model | d01, d02, d03 |
| Capa Superficial | Revised MM5 Monin-Obukhov scheme | d01, d02, d03 |
| Llamps | Yair et al., 2010 | d03 |

#### Cicle Operatiu i Inicialització
* Cicle Diari: El model s'executa diàriament a les 18 UTC.
* Condicions Inicials i de Contorn: S'inicialitza a partir de l'anàlisi de les 12 UTC del model GFS a 0.5 graus de resolució. Les 6 primeres hores es consideren com a Spinup.

#### Assimilació de Dades (Grid Nudging)
Per a estabilitzar i guiar la simulació en les seves fases inicials, s'aplica grid nudging (FDDA) al domini exterior (d01) cap a les condicions del model GFS. Aquest forçament es manté actiu únicament durant les 6 primeres hores de simulació. A més, s'exclou d'aquest procés la Capa Límit Planetària (PBL) per a permetre que el model resolgui localment la física de superfície sense interferències.
...
Per a l'extracció de variables d'impacte en el domini de major resolució (3 km), s'han activat els mòduls de diagnòstics de la AFWA i la parametrització de descàrregues elèctriques per al càlcul de l'Índex de Potencial de Llamps (LPI).
...
| Surface Layer | Revised MM5 Monin-Obukhov scheme | d01, d02, d03 |
| Lightning | Yair et al., 2010 | d03 |
